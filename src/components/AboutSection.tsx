        ...
        {locale === 'no' ? (
          ...
          <>
            ...
            <p>
              ...
              development from the Norwegian University of Science and
              Technology (NTNU).
            </p>
            <p>
              ...
              courses about TypeScript, Accessibility, Microfrontends and test
              driven development on Udemy to educate myself further.
            </p>
          </>
        )}
      </div>
